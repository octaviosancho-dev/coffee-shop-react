...
E-commerce focused on selling coffee and related products. The application includes a product catalog, filtering, and a shopping cart. This project was developed in ReactJS and is connected to a database in Google Firebase, where user purchases can be recorded, capturing their data, selected products, and quantities, providing an order code from the database.
